...
Works on both LeRobot v2.1 and v3.0 datasets (it only reads ``meta/info.json``,
whose feature names/dims are identical across the two layouts). Pure stdlib, so
it does not require the gr00t environment.
