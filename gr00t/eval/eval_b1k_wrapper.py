...
class B1KPolicyWrapper:
    def __init__(
        ...
        # Serving-only fields (robot name + live obs key mapping); see
        # register_modality_config / ROBOT_OBS_CONFIGS.
        self.robot_obs = ROBOT_OBS_CONFIGS[embodiment_tag.value]
